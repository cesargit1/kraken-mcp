"""Reset script: close all open positions and wipe agent_log + positions tables."""
...
# Delete ALL positions rows first (FK dependency on agent_log)
...
# Now safe to wipe agent_log
print("Clearing agent_log...")
client.table("agent_log").delete().neq("id", 0).execute()
